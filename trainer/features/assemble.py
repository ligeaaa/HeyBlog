...
from trainer.features.title_features import clean_title
...
from trainer.features.title_features import tokenize_title
...
def build_tfidf_documents(
    ...
    *,
    ...
    for sample in samples:
        ...
        title_tokens = tokenize_title(clean_title(sample.title))
